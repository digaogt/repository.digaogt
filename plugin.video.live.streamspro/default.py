...
def makeRequest(url, headers=None):
        try:
            if headers is None:
                headers = {'User-Agent' : 'Mozilla/5.0 (Linux; U; Android 5.1; en-US; SHIELD Android TV Build/LMY47D) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 UCBrowser/10.8.0.718 U3/0.8.0 Mobile Safari/537.36'}
...
def parse_m3u(data):
    ...
    for other,channel_name,stream_url in match:
        if stream_url.startswith('http'):
            ...
            elif '.mkv' or 'mp4' in stream_url:
                stream_url = urllib.quote_plus(stream_url)
...
#                            urllib2.getproxies= lambda: {}
                        ...
                        req.add_header('User-Agent', 'Mozilla/5.0 (Linux; U; Android 5.1; en-US; SHIELD Android TV Build/LMY47D) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 UCBrowser/10.8.0.718 U3/0.8.0 Mobile Safari/537.36')
